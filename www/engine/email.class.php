<?php
	...
	class Email {
		 ...
		 static function Enviar($nome_de, $de, $para, $assunto, $mensagem, $bcc="") {
			...
			$headers .= "Reply-To: ".$de."\n";
			//return mail($para, $assunto, $mensagem, $headers, "-rsupersoft@supersoft.com.br");
			return mail($para, $assunto, $mensagem, $headers);
		}  */		
		
		static function Enviar($nome_de, $de, $para, $assunto, $mensagem, $bcc="") {
			$ws = new SoapClient(null, array(
                'location' => "http://ws.supersoft.com.br/site/email.php", // Servidor da SS (Kirk).
                'uri' => "http://ws.supersoft.com.br/site/",
                'trace' => 0));
